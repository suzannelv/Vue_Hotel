<template>
  <div class="search">
    ...
    <div class="content">
      <div class="keyword">mot-clé/localisation</div>
    </div>
...
const startDateStr = computed(()=>formatMonthDay(startDate.value, "DD/MM"))
const endDateStr = computed(()=>formatMonthDay(endDate.value, "DD/MM"))
